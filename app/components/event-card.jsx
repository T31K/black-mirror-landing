...
export default function EventCard({ isShowPage = false }) {
  return (
    <div className="text-white py-10 px-4 max-w-5xl space-y-1 mx-auto">
      {isShowPage && (
        <h2 className="text-center text-3xl font-bold text-white sm:text-3xl mb-8 lg:text-4xl font-leckerli-one ">
          September
        </h2>
      )}
      ...
      {isShowPage && (
        <>
          <h2 className="text-center text-3xl font-bold text-white sm:text-3xl lg:text-4xl font-leckerli-one !my-6 ">
            October
          </h2>
