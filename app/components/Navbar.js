...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 lg:hidden transition-opacity duration-300  z-[555] ${
          isMenuOpen
          ...
          <div className="flex flex-col h-full pt-20 px-6">
            ...
            <nav className="flex flex-col space-y-6">
              ...
              <Link
                ...
                target="_blank"
                onClick={closeMenu}
                className="flex items-center space-x-3 text-lg font-medium text-white hover:text-purple-400 transition-colors duration-200 pt-4"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
